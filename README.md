...
The script generates aggressive full-speed network tuning with controlled queue depth and jitter. It covers BBR/sysctl/RPS/conntrack/initcwnd/nofile/TCP Fast Open output, and keeps application-layer mux/multiplex disabled by default.
...
```bash
bash bbr.sh             # menu-style interactive UI
